...
function processForm()
{
    $("#submit-button").on("click",function()
    {
        ...
        else
        {
            ...
            $("form").append(i);
            $("#thankYou").slideDown("slow",function(){$(this).delay(1500).slideUp("slow")})}
    })
}
...
function processLike()
{
    ...
    $(".featherlight-previous, .featherlight-next").on("click",function(){e.text("Like"),e.removeClass("highlight")});
    $(document).on("keyup",function(){e.text("Like"),e.removeClass("highlight")});
...
$(document).ready(function()
{
    ...
    (n>=18||7>=n)&&$(".darkable, #form").addClass("darkened");
    $("img").unveil(200,function(){$(this).css("opacity","1")});
    
    // Make Featherlight responsive to arrow button presses
    $(document).on("keydown",function(e){respToArrowPress(e)});
    ...
    $(".gallery img").on("load",function(){$(this).parent().css("animation","none")});
    
    // Make theme buttons responsive to clicks
    $("#dark-theme-button").on("click",function(){$(".darkable").addClass("darkened");});
    $("#light-theme-button").on("click",function(){$(".darkable").removeClass("darkened")})
